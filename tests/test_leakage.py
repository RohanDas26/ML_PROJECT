...
def sample_data():
    ...
    # Try multiple possible dataset locations for resilience
    candidates = [
        ROOT / "Data" / "USA ENGERY PREDICTION.xlsx",
        ROOT.parent / "Dataset" / "USA ENGERY PREDICTION.xlsx",
    ]
    ...
    pytest.skip(f"Data file not found in any of: {[str(p) for p in candidates]}")
